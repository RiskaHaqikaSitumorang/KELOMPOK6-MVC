                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <form method="post" name="registration" onSubmit="return valid();">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="inputPhone" type="text" name="mobileno" placeholder="Contact Number" maxlength="10" pattern="[0-9]+" required />
                                            <label for="inputPhone">Contact Number</label>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="inputPassword" type="password" name="newpassword" placeholder="Create a password" required />
